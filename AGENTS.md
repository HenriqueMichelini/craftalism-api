...
This repository owns authoritative backend behavior for economy operations, including transfers, transactions, idempotency, incident handling, and API error semantics.
...
- Follow docs/market-pressure-ladder-sigmoid-pricing.md strictly. Do not simplify or reinterpret.
