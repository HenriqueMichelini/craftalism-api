...
public final class MarketPricingPipeline {
    ...
    public long sellUnitPrice(MarketItem item, long adjustedBuyUnitPrice) {
    ...
    public record PricingContext(
        ...
        public static PricingContext neutral() {
