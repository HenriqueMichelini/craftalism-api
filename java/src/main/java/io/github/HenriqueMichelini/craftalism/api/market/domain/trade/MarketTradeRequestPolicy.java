...
public final class MarketTradeRequestPolicy {
    ...
    public MarketTradeRequestPolicy(
    ...
    public void validateQuantity(Long quantity, String snapshotVersion) {
    ...
    public void enforceRateLimit(UUID playerUuid, String snapshotVersion) {
    ...
    public void validateItemAvailability(MarketItem item, String snapshotVersion) {
    ...
    public MarketRejectionException rejection(
