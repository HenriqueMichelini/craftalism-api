...
It changes when backend-owned trade-affecting fields change, including `marketPressure`, configured hard pressure bounds, blocked/operating state, item update time, unit price bounds, segment size, pressure sensitivity, and regeneration config.
