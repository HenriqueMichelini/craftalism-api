...
public class TransactionController {
    ...
    @Operation(summary = "Get all transactions", description = "Returns a list of all transactions in the system")
    @GetMapping
    ...
    @Operation(summary = "Get transaction by ID", description = "Returns a specific transaction by its unique identifier")
    @GetMapping("/id/{id}")
    ...
    @Operation(summary = "Get transactions sent by player", description = "Returns all transactions where the specified player was the sender")
    ...
    @Operation(summary = "Get transactions received by player", description = "Returns all transactions where the specified player was the receiver")
    @GetMapping("/to/{uuid}")
    ...
    @Operation(summary = "Create new transaction", description = "Creates a new transaction transferring amount from one player to another")
    @PostMapping
